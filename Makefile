DB_DOCKER_CONTAINER=pg_container_app
...
create_docker_container:
	docker run --name ${DB_DOCKER_CONTAINER} -p 5432:5432 -e POSTGRES_USER=ehernandep -e POSTGRES_PASSWORD=Tonterias4316* -d postgres:12-alpine
